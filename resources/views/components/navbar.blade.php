<nav
    class="flex fixed z-10 w-full backdrop-blur-xl flex-row justify-between bg-blue-300/70 border-b border-neutral-600/30 shadow-md py-2 px-5">
    <div class="flex flex-row gap-5">
        <a href="{{ route('tasks') }}" class="font-bold text-lg text-gray-600">STANZEN /tasker /
